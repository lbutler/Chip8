(function() {
	...
	CHIP8.Cpu.video = new CHIP8.CanvasScreen(CHIP8.Cpu.gfx);
	...
	cycleButton.onclick = function() {
		...
		dumpMemoryArray(CHIP8.Cpu.V,'debug-V');
		dumpMemoryItem(CHIP8.Cpu.I, 'debug-I' );
		dumpMemoryItem(CHIP8.Cpu.pc, 'debug-pc' );
		dumpMemoryItem(CHIP8.Cpu.sp, 'debug-sp' );
		dumpMemoryArray(CHIP8.Cpu.stack,'debug-stack');
	};

	var drawButton = document.getElementById('draw-screen');
	drawButton.onclick = function() { CHIP8.Cpu.video.draw(); };
})();